...
$string['privacy:metadata:block_kuracloud_users'] = 'Mapping between Moodle user ID and kuraCloud user ID';
$string['privacy:metadata:block_kuracloud_users:userid'] = 'Moodle user ID';
$string['privacy:metadata:block_kuracloud_users:remote_studentid'] = 'kuraCloud user ID';
